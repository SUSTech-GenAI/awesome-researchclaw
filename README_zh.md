...
| [AI-Research-SKILLs](https://github.com/Orchestra-Research/AI-Research-SKILLs) ![Stars](https://img.shields.io/github/stars/Orchestra-Research/AI-Research-SKILLs?style=flat-square) | Orchestra-Research | ✓ | △ | ✓ | ✓ | △ | 87 个面向自主 AI 科研的技能库——双循环 autoresearch 编排（内层实验循环 + 外层综合循环）、研究构思、ML 论文写作（含 NeurIPS/ICML/ICLR/ACL/AAAI/COLM LaTeX 模板），以及训练、微调、评测、推理、可解释性等领域技能；一键安装：`npx @orchestra-research/ai-research-skills`。 |
